    ...
    if (audioBtn) {
        audioBtn.addEventListener("click", () => {
            if (!isRecording) {
                ...
                audioBtn.innerHTML = `<svg class="chakra-icon" viewBox="0 0 24 24"><path d="M12 12c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v4c0 1.66 1.34 3 3 3zm5.3-3c0 3.53-2.61 6.43-6 6.92V21h-2v-3.08c-3.39-.49-6-3.39-6-6.92H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-1.7z"/></svg>`;
            }
        });
    }
