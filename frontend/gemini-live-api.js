...
class GeminiLiveAPI {
    ...
    sendInitialSetupMessages() {
        console.log("Sending initial setup messages...");
        
        const serviceSetupMessage = {
            bearer_token: this.accessToken,
            service_url: this.serviceUrl,
        };
        console.log("Sending service setup message:", serviceSetupMessage);
        ...
        console.log("Sending session setup message:", sessionSetupMessage);
